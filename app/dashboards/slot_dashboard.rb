...
class SlotDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    features: Field::Select.with_options(searchable: false, collection: lambda { |field|
    ...
    slot_time: Field::Select.with_options(searchable: false, collection: lambda { |field|
                                                                           field.resource.class.send(field.attribute.to_s.pluralize).keys
                                                                         }),
    user: Field::HasOne,
